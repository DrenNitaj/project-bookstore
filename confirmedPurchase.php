    ...
    <section class="books-contain activee" id="books1">
        <div class="books-container">
            <div class="books-text">
                <i class="fas fa-check-circle" style="font-size: 60px; color: #4CAF50; margin-bottom: 10px;"></i>
                <h1>Purchase Confirmed</h1>
                <p>Your order has been received and is currently <strong>processed</strong> and pending review.<br>Once your payment is verified, the status will be updated to <strong>completed</strong> and your books will be shipped.<br>Thank you for choosing <strong>the BookHouse</strong>!</p>
            </div>
            <div class="buttons">
