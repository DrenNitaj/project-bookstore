                ...
                <table class="user-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="text" class="input" placeholder="Name" name="name" value="<?php echo $user['name'];?>" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="text" class="input" placeholder="Surname" name="surname" value="<?php echo $user['surname'];?>" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="text" class="input" placeholder="Username" name="username" value="<?php echo $user['username'];?>" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="email" class="input" placeholder="Email" name="email" value="<?php echo $user['email'];?>" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="number" class="input" placeholder="Phone Number" name="phonenumber" value="<?php echo $user['phone_number'];?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>    
                                <div class="input-div">
                                    <input type="text" class="input" placeholder="Address" name="address" value="<?php echo $user['address'];?>">
                                </div>
                            </td>
                        </tr>
                    </tbody>
