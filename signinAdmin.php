...
<head>
    ...
    <title>the BookHouse / Sign in as staff</title>
...
<body>
    ...
    <div class="books">
            ...
            <h1 class="sign-heading">Sign in</h1>
                <form action="signinAdminLogic.php" method="post">

                    <!-- <div id="or">
                        <div class="input-div">
                            <input type="email" class="input" placeholder="contact@email.com" name="email">
                ...
                <a id="userlink" href="signin.php">Sign in as User</a>
            </div> 
